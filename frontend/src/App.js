...
/** Must match CARTESIA_VOICE_<SLUG> in essence-cloud/.env (see frontend/.env.example). */
const CARTESIA_VOICE_BY_TUTOR = {
  leo: (process.env.REACT_APP_CARTESIA_VOICE_LEO || "").trim(),
  cub: (process.env.REACT_APP_CARTESIA_VOICE_CUB || "").trim(),
};
...
const AVATARS = [
  {
    ...
    ring: "lavender",
    cartesiaVoiceId: CARTESIA_VOICE_BY_TUTOR.leo,
  },
  // {
  //   id: "luna",
  //   emoji: "🦉",
  ...
  // },
  {
    ...
    ring: "sun",
    cartesiaVoiceId: CARTESIA_VOICE_BY_TUTOR.cub,
  },
];
        ...
        {screen === "tutor" && mode && topicSlug && (
          <section className="kid-card kid-card-tutor-live">
            <TutorRoom
              ...
              topicSlug={topicSlug}
              tutorSlug={avatarId}
              cartesiaVoiceId={tutorPick.cartesiaVoiceId || ""}
              childName={childName}
